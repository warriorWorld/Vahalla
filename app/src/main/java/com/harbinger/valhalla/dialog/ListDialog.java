...
import com.harbinger.valhalla.adapter.OnlyTextListAdapter;
import com.harbinger.valhalla.listener.OnRecycleItemLongClickListener;
        ...
        if (null == onlyTextListAdapter) {
            ...
            optionsLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (null != onListDialogClickListener) {
                        if (null != list && list.length > 0) {
                            onListDialogClickListener.onItemClick(position);
                            onListDialogClickListener.onItemClick(list[position]);
                            if (null != codeList && codeList.length > 0) {
                                onListDialogClickListener.onItemClick(list[position], codeList[position]);
                            }
                            dismiss();
                        }
                    }
